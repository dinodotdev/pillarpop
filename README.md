...
This privacy policy applies to the Pillar Pop app for mobile devices, together with any related services operated by dinodotdev (collectively, the "Application"). dinodotdev is hereby referred to as the "Service Provider".
